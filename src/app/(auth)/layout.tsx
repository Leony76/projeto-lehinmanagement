  ...
  return (
    <div className="flex flex-col min-h-dvh">
      ...
      <header
        ...
        `}
      >
        <nav className="relative z-60 flex justify-between items-center py-2 px-3 border-b-[1.5px] shadow-md border-primary  bg-linear-to-l from-primary to-primary-dark ">
          <ul>
